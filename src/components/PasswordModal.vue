...
const props = withDefaults(
  defineProps<{ mode: 'create' | 'edit' | 'delete'; busy?: boolean; error?: string }>(),
  { busy: false, error: '' },
)
...
const copy = {
  create: {
    title: '수정용 비밀번호 설정',
    description: '게시글 수정·삭제 시 사용할 비밀번호를 설정해 주세요.',
    action: '등록',
  },
  edit: {
    title: '수정용 비밀번호 확인',
    description: '작성할 때 설정한 비밀번호를 입력해 주세요.',
    action: '수정 완료',
  },
  delete: {
    title: '게시글 삭제',
    description: '비밀번호가 일치하면 게시글이 즉시 삭제됩니다.',
    action: '삭제',
  },
}[props.mode]
